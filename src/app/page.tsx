...
export default function Home() {
  return (
    ...
    <main className="flex h-screen w-full bg-black bg-grid-white/[0.2] relative items-center justify-centermin-h-screen flex-col justify-between">
      <div className="relative flex items-center justify-center flex-grow space-y-2"> {/* Added flex-grow and flex properties */}
        <Image
